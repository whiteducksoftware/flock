...
- [Observability & Debugging (AGENTS.md)](../AGENTS.md#observability--debugging-with-opentelemetry--duckdb)
- [Auto Tracing Documentation](AUTO_TRACING.md)
- [DuckDB Schema Reference](../AGENTS.md#duckdb-schema-reference)
