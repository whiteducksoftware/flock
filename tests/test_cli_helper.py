...
class TestVersionHandling:
    ...
    def test_version_from_package(self):
        ...
        import flock_flow.helper.cli_helper

        # The version should be loaded from the package
        assert hasattr(flock_flow.helper.cli_helper, "__version__")
        # It should be a string
        assert isinstance(flock_flow.helper.cli_helper.__version__, str)
        # It should match semantic versioning pattern
        import re

        assert re.match(r"^\d+\.\d+\.\d+", flock_flow.helper.cli_helper.__version__)
    ...
    def test_version_fallback_on_package_not_found(self):
        ...
        if "flock_flow.helper.cli_helper" in sys.modules:
            del sys.modules["flock_flow.helper.cli_helper"]
        ...
        with patch("importlib.metadata.version") as mock_version:
            ...
            assert flock_flow.helper.cli_helper.__version__ == "0.2.0"
...
class TestDisplayHummingbird:
    ...
    def test_display_hummingbird_prints_output(self, capsys):
        ...
        from flock_flow.helper.cli_helper import display_hummingbird
...
class TestInitConsole:
    ...
    def test_init_console_default_params(self, mock_console_class):
        ...
        from flock_flow.helper.cli_helper import init_console
    ...
    @patch("rich.console.Console")
    @patch("flock_flow.helper.cli_helper.__version__", "test-version")
...
class TestDisplayBannerNoVersion:
    ...
    def test_display_banner_no_version_basic(self, mock_console_class):
        ...
        from flock_flow.helper.cli_helper import display_banner_no_version
...
class TestEdgeCases:
    ...
    def test_multiple_console_creations(self, mock_console_class):
        ...
        from flock_flow.helper.cli_helper import display_banner_no_version, init_console
...
class TestImportBehavior:
    ...
    def test_module_imports_successfully(self):
        ...
        importlib.reload(flock_flow.helper.cli_helper)

        # Check that all expected functions are available
        assert hasattr(flock_flow.helper.cli_helper, "display_hummingbird")
        assert hasattr(flock_flow.helper.cli_helper, "init_console")
        assert hasattr(flock_flow.helper.cli_helper, "display_banner_no_version")
        assert hasattr(flock_flow.helper.cli_helper, "__version__")
    ...
    def test_rich_imports_lazy(self):
        ...
        with patch("rich.console.Console"):
            flock_flow.helper.cli_helper.init_console(show_banner=False)
