    ...
    async with flock.traced_run("mystery_cases"):
        crime_scenes = [
            CrimeScene(
                ...
                witness_statements=["Heard shouting around 9 PM", "Saw someone in maintenance uniform", "Elevator was broken that evening"],
                time_of_incident="2025-10-09 21:15"
            ),
            CrimeScene(
                location="Art gallery after charity auction",
                evidence=["Broken alarm sensor", "Muddy footprints size 10", "Missing painting worth $2M"],
                witness_statements=["Delivery truck parked outside", "Staff left early", "Power outage lasted 10 minutes"],
