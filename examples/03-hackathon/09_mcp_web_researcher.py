...
to browse the web, collect information, and save a report – all without
...
- End-to-end workflow: ResearchTask → ResearchReport → Markdown file
...
def write_markdown_report(content: str, file_name: str) -> str:
    ...
    print(f"✍️  Wrote report to: {file_path}")
...
try:
    ...
    print("✅ Added website reader MCP (read_website)")
except Exception as e:  # pragma: no cover - environment dependent
    print(
        f"⚠️  Could not add website reader MCP "
...
async def main_cli() -> None:
    ...
    print("=" * 80)
    print("🧠 MCP WEB RESEARCHER - Hackathon Track 09")
    print("=" * 80)
    print()
    ...
    if not reports:
        print("❌ No ResearchReport artifacts were generated.")
    ...
    if report.report_file:
        ...
        print("📝 No markdown file was created (agent may have skipped the tool).")


async def main_dashboard() -> None:
    """Dashboard mode: Serve with interactive web interface."""
    print("🌐 Starting Flock Dashboard for MCP Web Researcher...")
